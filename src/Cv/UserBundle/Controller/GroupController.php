...
use Cv\UserBundle\Entity\Group;
use Cv\UserBundle\Form\GroupType;
...
class GroupController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CvUserBundle:Group')->findAll();
     ...
     *
     * @Route("/", name="admin_group_create")
     * @Method("POST")
     * @Template("CvUserBundle:Group:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CvUserBundle:Group')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="admin_group_update")
     * @Method("PUT")
     * @Template("CvUserBundle:Group:edit.html.twig")
     */
